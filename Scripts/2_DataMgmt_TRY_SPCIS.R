...
TRY_SpeciesName_list_TNRS <- read.csv("/Users/MagdaGarbowski 1/TraitShifts/Generated_Data/TRY_SpeciesName_TNRS_22398.csv")
...
out_TNRS_dfs <- lapply(list(TRY_SpeciesName_list_TNRS = TRY_SpeciesName_list_TNRS,
...
TRY_ss_SpeciesName_merge <- merge(TRY_ss, TRY_SpeciesName_list_TNRS, 
